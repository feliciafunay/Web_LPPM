        ...
        <div class="container-admin">
            ...
            <div class="single-pricing">
                <div class="single-pricing-content">
                    <h5>Penelitian</h5>
                    <a href="/penelitian/create" class="btn btn-primary mb-3 btn-sm" style="color:#fff; font-size:14px">Tambah Data</a>
                    ...
                    <div class="row mb-3 ml-1">
                        <a href="/penelitian/{{ $rsc->id }}/edit" class="btn btn-outline-info btn-sm mr-1" style="color:#000; font-size:10px">Edit</a>
